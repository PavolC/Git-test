...
.controller('gitTestCtrl', ['$scope', '$http', '$q','gitTestFactory', function ($scope, $http, $q, gitTestFactory) {
    ...
    $scope.insertValue = gitTestFactory.insertValue;
    $scope.loading = gitTestFactory.loading;
    $scope.links = gitTestFactory.links;
    $scope.openDataExampleData = gitTestFactory.openDataExampleData;
    $scope.dbData =  gitTestFactory.dbData;
...
.factory('gitTestFactory', ['$http', '$rootScope', '$filter', '$q', function ($http, $rootScope, $filter, $q) {
...
.directive('gitTestDirectiveName', ['$http', function ($http) {
    return {
...
.filter('gitTestFilterName', function () {
